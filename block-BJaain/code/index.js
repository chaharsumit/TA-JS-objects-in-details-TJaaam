...
let outerFn = function () {
  let n = 5;
  console.log(innerItem); // Reference Error innerItem is not defined
...
object.double(); // [2,4,6]
/*
  this is inside of outerFn double()
  [object]
  map output is window for console.log
*/
object.doubleArrow(); // [2,4,6]
/*
  this is inside of outerFn doubleArrow()
  [object]
  map output is object for console.log
*/
